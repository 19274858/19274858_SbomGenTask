...
var githubVulnerabilityProvider_1 = require("./src/providers/githubVulnerabilityProvider");
var htmlProducer_1 = require("./src/producers/htmlProducer");
var fs_1 = __importDefault(require("fs"));
var path_1 = __importDefault(require("path"));
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var reportOutputNames, includeColumns, workingDirectory, outputDirectory_1, solution, jsonOutputPath, vulnerabilityInfoJsonPath_1, reportOutputNamesArray, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    reportOutputNames = tl.getInput('reportoutputname', true);
                    ...
                    return [4 /*yield*/, (0, cycloneDxAgent_1.getSbom)(solution, outputDirectory_1)];
                case 1:
                    ...
                    return [4 /*yield*/, (0, githubVulnerabilityProvider_1.getVulnerabilityInfo)(jsonOutputPath, outputDirectory_1, 'SBOM_NUGET_API.json')];
                case 2:
                    vulnerabilityInfoJsonPath_1 = _a.sent();
                    if (!vulnerabilityInfoJsonPath_1) {
                        tl.setResult(tl.TaskResult.Failed, "Unable to get the vulnerability information");
                        return [2 /*return*/];
                    }
                    reportOutputNamesArray = reportOutputNames.split(',');
                    reportOutputNamesArray.forEach(function (reportOutputName) {
                        var htmlOutputPath = (0, htmlProducer_1.convertToHTML)(vulnerabilityInfoJsonPath_1, outputDirectory_1, reportOutputName);
                    });
                    tl.setResult(tl.TaskResult.Succeeded, "SBOM analysis completed successfully. SBOM reports generated at: ".concat(outputDirectory_1));
                    return [3 /*break*/, 4];
                case 3:
                    err_1 = _a.sent();
