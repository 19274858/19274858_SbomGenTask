...
import { getSbom } from './agents/cycloneDxAgent';
import { getPackageInfo } from './providers/githubVulnerabilityProvider';
import { convertToHTML } from './producers/htmlProducer';
import { convertToCsv } from './producers/csvProducer';
import fs from 'fs';
...
async function run() {
    try {
        ...
        const jsonOutputPath = await getSbom(solution, outputDirectory, reportoutputname);
